...
/// <reference types="openlayers" />
  class FloorSwitcherControl extends ol.control.Control {
    private movinMap;
 ...
 */
  class MovinOLMap extends ol.Map {
    private movinMap;
...
/// <reference types="openlayers" />
  abstract class MovinCanvasSource extends ol.source.ImageCanvas {
...
/// <reference types="openlayers" />
  class MovinPOISource extends MovinCanvasSource {
    private renderHelper;
    private renderer;
...
/// <reference types="openlayers" />
  class MovinTextSource extends MovinCanvasSource {
    private renderHelper;
    private renderer;
    private lastRenderResult;
    private spatialDictionary;
...
/// <reference types="openlayers" />
  class MovinTileSource extends ol.source.XYZ {
    private tileProvider;
